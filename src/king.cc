...
King::King(int c, int row, int col) : Piece(c, row, col){
...
void King::movePiece(const int& row, const int& col){
...
bool King::checkIsValidMovement(int& row, int& col, const std::vector<std::vector<Piece*>>& board){
